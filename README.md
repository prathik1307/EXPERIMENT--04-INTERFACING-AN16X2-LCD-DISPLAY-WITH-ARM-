...
int main(void)
{
  ...
  Lcd_PortType ports[]={GPIOA,GPIOA,GPIOA,GPIOA};
     ...
     lcd=Lcd_create(ports,pins,GPIOB,GPIO_PIN_0,GPIOB,GPIO_PIN_1,LCD_4_BIT_MODE);    Lcd_cursor(&lcd,0,1);
     Lcd_string(&lcd,"Prathiksha R");
     Lcd_cursor(&lcd,1,1);
...
<img width="1916" height="1146" alt="Screenshot 2026-03-22 142726" src="https://github.com/user-attachments/assets/b2cad34b-1367-4630-bc22-2e24731db399" />
